...
<body>
	...
	<div class="container">
		...
		<div class="form">
		<form method="POST" action="${pageContext.request.contextPath}/user-otp-validate">
			<c:if test="${userMailSentOtp != null}">
				${userMailSentOtp }
			</c:if>
			...
			<input class="input_field" type="text" maxlength="6" required placeholder="Enter OTP" name="userOtp">
