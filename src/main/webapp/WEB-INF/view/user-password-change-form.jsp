...
<body>
	...
	<div class="container">
		...
		<form method="POST" action="#" onsubmit="return validatePassword()">
			<input class="input_field" id="pass" type="password" required placeholder="Enter Password" onkeyup="validatePassword()" >
			<input class="input_field" type="password" id="repass" required placeholder="Re-Enter Password" name="userPassword" onkeyup="validatePassword()">
			<p id="msg"></p>
